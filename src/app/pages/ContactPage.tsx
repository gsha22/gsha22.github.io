...
const socials = [
	...
	{ name: "LinkedIn", href: "https://www.linkedin.com/in/gabriel-sha-64b581251/", icon: LinkedinIcon },
			...
			<main className="flex-1 md:ml-60 pt-28 md:pt-16">
				...
				<ContentContainer>
					...
					<section className="mt-10">
						<h2 className="text-2xl font-semi text-black dark:text-offwhite font-sans">my social media</h2>
